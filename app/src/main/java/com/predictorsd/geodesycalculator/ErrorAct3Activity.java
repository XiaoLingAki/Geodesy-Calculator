...
public class ErrorAct3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_error_act3);

        final EditText editText1=findViewById(R.id.act3edit1);
        final EditText editText2=findViewById(R.id.act3edit2);

        final EditText editText3=findViewById(R.id.act3result1);
        final EditText editText4=findViewById(R.id.act3result2);

        Button button=findViewById(R.id.act3button);
