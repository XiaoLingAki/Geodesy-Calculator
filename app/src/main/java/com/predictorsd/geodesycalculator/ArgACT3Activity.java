...
public class ArgACT3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_arg_act3);

        TextView textView=findViewById(R.id.arg_act3_content);
    ...
    private String calstring(){
        ...
        re = new StringBuilder("CGCS2000椭球体参数：" + "\n");
        double a = 6378140;
